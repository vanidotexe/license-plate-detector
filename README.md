...
Open source: Feel free to use, modify, and improve this project.

## Quick Start

- Install Python dependencies from `requirements.txt` using `pip`
- Install Tesseract through your favorite package manager (`apt` / `brew` / `winget` / `chocolatey`)
- Usage example: `python3 detectplate.py <path/to/image>`
